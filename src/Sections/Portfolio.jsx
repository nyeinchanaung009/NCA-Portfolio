    ...
    <>
        ...
        <section id="portfolio" className="sm:min-h-[85vh] md:min-h-[93vh]">
            <div className="bg-bg3 pb-20 sm:py-28 md:py-32">
                <div className="w-11/12 md:w-10/12 mx-auto flex justify-center items-center flex-wrap">
                    <div className="w-full sm:w-6/12 pt-16 pb-24 sm:pt-0 sm:pb-0 myanimation -translate-x-14 opacity-0 duration-[0.85s] ease-out delay-[0.3s]">
                        <img onClick={() => navigate('/projectdetail/1')} className="w-[300px] sm:w-[360px] mx-auto sm:mx-0 sm:ms-auto saturate-150 brightness-90 scale-y-[1.1] boxshadow hover:opacity-80 cursor-pointer" src="/project_images/puccaMockup.png" alt="pucca mockup" />
                    </div>
                    <div  className="w-full sm:w-6/12">
                        <div className="w-[180px] sm:w-[290px] sm:ps-8 md:ps-16 mx-auto sm:mx-0 relative">
                            <div className='myanimation -translate-x-14 opacity-0 duration-[0.85s] ease-out delay-[0.45s]'>
                                <h1 className="titleblock1 relative text-tpri font-finter font-bold text-[21px] tracking-wide"><span className="text-accentblue">Pucca</span> Jewellery</h1>
                            ...
                            <h1 className='absolute -right-8 sm:-right-2 -top-8 text-[46px] font-bold font-fbebas tstroke'>#1</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="w-11/12 md:w-10/12 mx-auto flex justify-center items-center flex-wrap">
                    <div  className="w-full sm:w-6/12 order-2 sm:order-1 mt-8 sm:mt-0">
                        <div className="w-[175px] md:w-[290px] mx-auto xl:mx-0 xl:ms-auto relative text-end md:pe-16 lg:pe-0 xl:me-24">
                            <div className='myanimation -translate-x-14 opacity-0 duration-[0.85s] ease-out delay-[0.45s]'>
                                <h1 className="titleblock2 relative text-white font-finter font-bold text-[21px] tracking-wide">M-vix <span className="text-accentblue">Movies</span></h1>
                            ...
                            <h1 className='absolute text-transparent right-36 sm:right-40 -top-11 text-[46px] font-bold font-fbebas tstroke'>#2</h1>
                        </div>
                    </div>
                    <div  className="w-full sm:w-6/12 order-1 sm:order-2 pt-16 pb-24 sm:pt-0 sm:pb-0 myanimation -translate-x-14 opacity-0 duration-[0.85s] ease-out delay-[0.3s]">
                        <img onClick={() => navigate('/projectdetail/2')} className="w-[300px] sm:w-[365px] mx-auto sm:mx-0 sm:-translate-x-6 md:-translate-x-10 saturate-[1.1] scale-y-[1.1] boxshadow hover:opacity-80 cursor-pointer" src="project_images/mvixMockup.png" alt="mvix mockup" />
                    </div>
                </div>
            </div>
            ...
            <div className="bg-bg3 pb-20 sm:py-28 md:py-32">
                <div className="w-11/12 md:w-10/12 mx-auto flex justify-center items-center flex-wrap">
                    <div  className="w-full sm:w-6/12 pt-16 pb-24 sm:pt-0 sm:pb-0 myanimation -translate-x-14 opacity-0 duration-[0.85s] ease-out delay-[0.3s]">
                        <img onClick={() => navigate('/projectdetail/3')} className="w-[300px] sm:w-[365px] mx-auto sm:mx-0 sm:ms-auto saturate-150 scale-y-[1.11] boxshadow hover:opacity-80 cursor-pointer" src="project_images/memoMockup.png" alt="" />
                    </div>
                    <div  className="w-full sm:w-6/12">
                        <div className="w-[180px] sm:w-[290px] sm:ps-8 md:ps-16 mx-auto sm:mx-0 relative">
                            <div className='myanimation -translate-x-14 opacity-0 duration-[0.85s] ease-out delay-[0.45s]'>
                                <h1 className="titleblock1 relative text-tpri font-finter font-bold text-[21px] tracking-wide"><span className="text-accentblue">Mymemo</span> Note</h1>
                                <h1 className="text-tsec text-sm font-fsora font-extralight tracking-wide">Note app, Todo list</h1>
                                <div className="flex justify-start items-start space-x-3 mt-[14px] mb-5">
                                    <Reacticon className="text-iconcolor text-[22px] cursor-pointer" />
                                    <Tailwindicon className="text-[22px] cursor-pointer" />
                                </div>
