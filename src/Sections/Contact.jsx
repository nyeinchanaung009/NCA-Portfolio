                    ...
                    <div className="w-[96%] min-[430px]:w-[80%] min-[500px]:w-[384px] md:w-[360px] lg:w-[460px] xl:w-[520px] mx-auto md:mx-0 lg:mx-auto">
                      ...
                      <form onSubmit={Send} id='contact_form'>
                        <div className='md:flex justify-center items-center md:space-x-3'>
                          <input ref={nameRef} name="user_name" placeholder='Your Name' type="text" className='contactinput1 w-full bg-blurbg2 inputborder text-sm rounded-[4px] outline-none ring-[1px] ring-transparent focus:ring-accentblue shadow px-3 lg:px-4 py-[11px] text-tpri placeholder:text-tmute font-light mb-3 myanimation opacity-0 -translate-y-4 ease-out' />
                          <input ref={emailRef} name="user_email" placeholder='Your Email' type="email" className='contactinput2 w-full bg-blurbg2 inputborder text-sm rounded-[4px] outline-none ring-[1px] ring-transparent focus:ring-accentblue shadow px-3 lg:px-4 py-[11px] text-tpri placeholder:text-tmute font-light mb-3 myanimation opacity-0 -translate-y-4 ease-out' />
                        </div>
                        <input ref={titleRef} name="subject" placeholder='Title' type="text" className='contactinput3 w-full bg-blurbg2 inputborder text-sm rounded-[4px] outline-none ring-[1px] ring-transparent focus:ring-accentblue shadow px-3 lg:px-4 py-[11px] text-tpri placeholder:text-tmute font-light mb-3 myanimation opacity-0 -translate-y-4 ease-out' />
                        <textarea name="message" ref={messageRef} className='contactinput4 w-full bg-blurbg2 inputborder rounded-[4px] outline-none ring-[1px] ring-transparent focus:ring-accentblue shadow px-3 lg:px-4 py-[11px] text-tpri placeholder:text-tmute font-light mb-3 myanimation opacity-0 -translate-y-4 ease-out' cols="55" rows="8" placeholder='Message'></textarea>
